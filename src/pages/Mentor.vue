  ...
  <div>
    ...
    <div class="infoPage mx-auto container lg:p-10 flex pt-8 flex flex-col justify-center p-5">
      <div class="flex flex-col-reverse lg:flex-row lg:justify-between w-full">
        <div class="mx-auto">
          <h1 class="font-bold text-5xl sm:text-7xl text-primary small-spacing font-serif">Mentor</h1>

          <p class="faqText">Our quality mentors are a crucial factor in what sets Hyphen-Hacks apart from other
            hackathons. As a mentor, you will create meaningful connections with high school students interested in
            programing. You will travel from team to team, assisting students with questions they may have about the
            process of software development.</p>
          <p class="faqText">In addition, mentors get access to all meals for free as well as complimentary swag. If you
